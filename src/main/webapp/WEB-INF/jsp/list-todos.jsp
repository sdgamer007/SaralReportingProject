					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								style=" height: 200px; width: 90%; float: none; margin:auto; display: none; background-color: aliceblue;">
								<%-- <form action="${pageContext.request.contextPath}/DesignReport?action=fetchColumns" method="post"> --%>
									...
									<input type="submit" class="btn btn-purple no-border" id="getcol" value="Get Columns" />
						...
						<div class="container" id="selcol" style="display: none;">
							<div class="container " id="collist"  style="width: 550px; float: left;">
								<h3  align="left">Please select Columns below :</h3>
							...
							<div class="container" id="selcollist" style="width: 560px; float: left;">
								<H3 align="left">Selected columns for report</H3>
								<div id="sortable1"
									style="overflow: scroll;height: 300px;width: 80%;float: left;background-color: aliceblue;">
							...
							<div class="container"  style="width: 90%; float: right;">
								...
								<div id="customReportDesigner"
									...
									<form
										<%-- action="${pageContext.request.contextPath}/SaveReport" --%> id="mycustreport"
										...
										<input type="hidden" id="userID" name="userID"
											...
											id="selectedColList" name="selectedColList" />
										<div class="form-group">
											<label class="control-label col-sm-4" for="rpName">Report
												Name:</label>
											<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="control-label col-sm-4" for="rpColor">
												Table Color:</label>
											<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="control-label col-sm-4" for="tooltip">
												Tool-tip:</label>
											<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="control-label col-sm-4" for="bgtext">Report
										...
										<div class="form-group">
											<label class="control-label col-sm-4" for="rpGrpBy">
										...
										<input class="form-group" type="hidden" name="grpIdName"
											id="grpIdName" />
										<div class="form-group">
											<label class="control-label col-sm-4" for="rpWhrCondition">WHERE
												CONDITION :</label>
											<div class="col-sm-8">
												<input type="text" class="form-control" id="rpWhrCondition"
													placeholder="Enter Where Condition" name="rpWhrCondition">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-sm-4" for="rpHeader">Report
												Header Text:</label>
											<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="control-label col-sm-4" for="rpFooter">
						...
						<div id="MarkAggregationAndGrouping" class="cus-setting-panel-div"
							style="display: none;">
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Saral Haryana</span>
							 &copy; NIC
						</span>
